...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_performsGETRequestWithURL() {
        ...
        URLProtocolStub.observeRequests { request in
            ...
            exp.fulfill()
            URLProtocolStub.removeObserveRequests()
        }
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        XCTAssertEqual(removeUserInfoOn(error: receivedError), requestError)
    }
    ...
    private func removeUserInfoOn(error: Error?) -> NSError? {
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        static func removeObserveRequests() {
            requestObserver = nil
        }
